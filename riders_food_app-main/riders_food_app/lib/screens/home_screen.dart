  ...
  getRiderPreviousEarnings() {
    FirebaseFirestore.instance
      ...
      if (snap.exists) {
        ...
        print("Error: Rider document does not exist.");
      }
    }).catchError((error) {
      print("Error fetching rider earnings: $error");
    });
  }
  ...
  getPerParcelDeliveryAmount() {
    FirebaseFirestore.instance
      ...
      if (snap.exists) {
        ...
        print("Error: perDelivery document does not exist.");
      }
    }).catchError((error) {
      print("Error fetching per parcel delivery amount: $error");
    });
  }
